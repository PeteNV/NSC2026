    ...
    return (
        ...
        <View style={styles.rows}>
            <View style={styles.month}>
                <Text variant = "labelMedium" style={{ color: colors.secondary }}>Monthly Estimate</Text>
                <Text variant = "bodyLarge" style={{ fontSize: 18, color: colors.onPrimaryContainer }}>~2,159 Baht</Text>
            </View>
            <View style={styles.month}>
                <Text variant = "labelMedium" style={{ color: colors.secondary }}>CO2 Footprint</Text>
                <Text variant = "bodyLarge" style={{ fontSize: 18, color: colors.onPrimaryContainer }}>14.79 kg</Text>
            </View>
        </View>
